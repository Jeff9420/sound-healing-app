...
const AUDIO_CONFIG = {
    ...
    categories: {
        'Animal sounds': {
            ...
            files: [
                '001.喜鹊叫声、犬吠、 布谷鸟交织在一起的华丽乐章.mp3',
                '003.天空上非常空灵的鸟叫，不知道什么名字.mp3',
                '004.枕着鸟儿的欢叫、母鸡的悠闲睡眠.mp3',
                '005.山间清澈的小溪声音伴着清脆的鸟叫（上）.mp3',
                '006.山间清澈的小溪声音伴着清脆的鸟叫（中）.mp3',
                '007.山间清澈的小溪声音伴着清脆的鸟叫（下）.mp3',
                '008.海鸥的叫声，海浪的声音（上）.mp3',
                '009.海鸥的叫声，海浪的声音（下）.mp3',
                '013.气场修补：钵声.敲与磨.潺潺流水.鸟鸣.mp3',
                '022.歌唱的小鸟 减压静心 配舒缓音乐（上）.mp3',
                '023.歌唱的小鸟 减压静心 配舒缓音乐（中）.mp3',
                '024.歌唱的小鸟 减压静心 配舒缓音乐（下）.mp3',
                '028.河边点燃篝火、水声和清脆的鸟鸣01.mp3',
                '029.河边点燃篝火、水声和清脆的鸟鸣02.mp3',
                '030.河边点燃篝火、水声和清脆的鸟鸣03.mp3',
                '041.非常难得的清脆鸟叫，深山里录制.mp3',
                '064.森林里百灵鸟鸣叫.mp3',
                '145. 【大自然韵律】鸟儿欢快的鸣叫.mp3',
                '146. 【海鸥】超自然睡眠版.mp3',
                '157. 天籁之音，清脆的鸟鸣【放松减压】.mp3',
                '158. 天然大森里的动物欢叫声音.mp3',
                '159. 蜜蜂与小鸟对唱.mp3',
                '162. 【沉浸】鸟语花香，流年岁月.mp3',
                '202. 动物叫声 空旷山谷里的杜鹃.mp3',
        ...
        'meditation': {
            ...
            files: [
                '015.冥想 瑜伽必听.mp3',
                '018.听海观岸，纯海浪的声音 冥想...mp3',
                '042.好听的瑜伽冥想音乐.mp3',
                '043.大自然冥想音乐---听声音.mp3',
                '044.冥想引导词，睡前..曲，专治失眠.mp3',
                '045.带您进入深层次睡眠.mp3',
                '046.美妙的音乐，打坐冥想，帮助睡眠，.mp3',
                '047.冥想放松 瑜伽舒缓音乐.mp3',
                '069. 盘坐冥想，空灵放松.mp3',
                '073. 开悟.mp3',
                '074. 空怀虚谷.mp3',
                '075. 静心 大彻大悟.mp3',
                '100. 疗愈神经衰弱，夜深人静聆听.mp3',
                '165. 减压舒缓放松的神奇音乐.mp3'
            ]
        },
        'Rain': {
            ...
            files: [
                '017.倾听山谷中小雨，净化心灵.mp3',
                '077. 奶奶家里听打雷下雨-..必备，治愈失眠.mp3',
                '078. 小时候打雷下雨-..必备，治愈失眠01.mp3',
                '079. 小时候打雷下雨-..必备，治愈失眠02.mp3',
                '080.  记住乡愁打雷下雨-..必备，治愈失眠03.mp3',
                '081. 记住乡愁打雷下雨-..必备，治愈失眠04.mp3',
                '082. 记住乡愁打雷下雨-..必备，治愈失眠05.mp3',
                '083. 记住乡愁打雷下雨-..必备，治愈失眠06.mp3',
                '084. 记住乡愁打雷下雨-必备，治愈失眠07.mp3',
                '085. 记住乡愁雷雨过后-..必备，治愈失眠08.mp3',
                '086. 记住乡愁打雷下雨-..必备，治愈失眠09.mp3',
                '088. 一声闷雷，大雨倾盆.mp3',
                '089. 身临情景的雨声.mp3',
                '5小时小雨 入眠 助眠，学习，冥想，放松 .mp3'
            ]
        },
        'running water': {
            name: '流水声',
            ...
            files: [
                ...
                '029.河边点燃篝火、水声和清脆的鸟鸣02.mp3',
                '030.河边点燃篝火、水声和清脆的鸟鸣03.mp3',
                '031.缓缓流水，温柔的抚摸脸颊，恋人般的感觉（上）.mp3',
                '032.缓缓流水，温柔的抚摸脸颊，恋人般的感觉（下）.mp3'
            ]
        },
        'Singing bowl sound': {
            name: '颂钵声音',
            ...
            files: [
                '010.能量颂-钵声.音，调整身心压力.mp3',
                '011.能量颂-钵声.音，敲击与磨缓解精神压力.mp3',
                '012.钵声与潺潺流水.鸟鸣. 静心.舒压.mp3',
                '014.顶级水晶钵颂音.音疗.mp3',
                '016.当安静音乐相遇钵音，简直美极了.mp3',
                '01-Healing Bowls - Instrumental - Jane Winther.mp3',
                '02-Falling Still (Moving Toward Nothingness) - Diane Mandle.mp3',
                '033.钵音按摩 流水涤荡心灵，静心.mp3',
                '035.音愈：钵音水泡，治疗睡眠不足.mp3',
                '036.颂钵音疗，平躺或，放下身心，全然融入的体会.mp3',
                '03-Return to Om - Diane Mandle.mp3',
                '04-Singing Bowls - Tibetan Meditation Academy.mp3',
                '055.钵音+水声+鸟叫自然声 让你平静下来的声音 01.mp3',
                '056.钵音+水声+鸟叫自然声 让你平静下来的声音 02.mp3',
                ...
                '137. 【颂钵+山间鸟鸣】让你的眼睛更舒服、明亮、清澈.mp3',
                '138. 【颂钵+夜晚鸟鸣】清静自然，独享一份清雅.mp3',
                '13-Singing Bowls & Bells - Jane Winther.mp3',
                '141. 【颂钵按摩】获得超级能量.mp3',
                '142. 【颂钵】神奇的声音按摩.mp3',
                '143. 【颂钵.静心】急速释放负面情绪.mp3',
