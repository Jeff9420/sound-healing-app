...
(() => {
  ...
  class BrowserCompatibility {
    ...
    addCompatibilityClasses() {
      ...
      // 添加浏览器类
      if (this.features.isMobile) html.classList.add('mobile-device');
      if (this.features.isSafari) html.classList.add('safari');
      if (this.features.isFirefox) html.classList.add('firefox');
      if (this.features.isChrome) html.classList.add('chrome');
      if (this.features.isEdge) html.classList.add('edge');
      if (this.features.isIE) html.classList.add('ie');

      // 添加功能类
      if (this.features.touch) html.classList.add('touch-enabled');
      if (this.features.cssVariables) html.classList.add('css-variables');
      if (!this.features.flexbox) html.classList.add('no-flexbox');
      if (!this.features.grid) html.classList.add('no-grid');
