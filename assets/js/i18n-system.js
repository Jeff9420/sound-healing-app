    ...
    getTranslationData(langCode) {
        const translations = {
            'zh-CN': {
                ...
                // AI 体验
                'ai.hero.eyebrow': 'SoundFlows AI · 15秒读懂你的状态',
                'ai.hero.title': '遇见你的AI声音疗愈顾问',
                'ai.hero.desc': '告诉我们你的情绪，我们会把213+声景、仪式引导与轻度提醒匹配到你身上，由睡眠科学家与冥想教练共同调校。',
                'ai.hero.primary': '开启我的AI疗程',
                'ai.hero.secondary': '浏览疗愈旅程',
                'ai.hero.chat.user': '“我总是凌晨三点醒来，对明天感到焦虑。”',
                'ai.hero.chat.assistant': '“收到。我会放慢呼吸节奏，排队θ波雨声并调暗视觉，需要加入身体扫描提醒吗？”',
                'ai.hero.reco.title': '智能推荐',
                'ai.hero.reco.first': '深睡雨声 + Alpha 钵 · 45 分钟',
                'ai.hero.reco.second': '午夜焦虑复位 · 20 分钟教练',
                'ai.hero.reco.play': '播放',
                'ai.hero.reco.learn': '了解',
                'ai.hero.logo.harvard': '波士顿 Sleep Hygiene Lab',
                'ai.hero.logo.clinic': 'Mindful Breathing Clinic 合作',
                'ai.hero.logo.press': 'CalmTech Journal 专题报道',
                'ai.hero.logo.community': '12万+ 匿名疗程数据',
                'ai.bento.eyebrow': '疗程旅程',
                'ai.bento.title': '一个顾问，四种仪式',
                'ai.bento.desc': 'AI 模型按照意图混合心率友好的节拍、双耳频率与自然声景。可自主选择，或由AI全程引导。',
                'ai.bento.sleep.title': '深睡加速',
                'ai.bento.sleep.desc': '45分钟温暖雨声+呼吸提示，渐进唤醒铃可选。',
                'ai.bento.anxiety.title': '平复焦虑循环',
                'ai.bento.anxiety.desc': '检测思绪过载时插入引导语与海浪，稳定心率并附带日记提醒。',
                'ai.bento.focus.title': '专注气泡',
                'ai.bento.focus.desc': '清爽白噪和咖啡店声组合，25分钟自动提醒休息。',
                'ai.bento.energy.title': '脉轮共振',
                'ai.bento.energy.desc': '七段短仪式，唱诵与颂钵频率对应每个脉轮。',
                'ai.cta.eyebrow': '签名计划',
                'ai.cta.title': '免费开启 7 天 AI 声音静修',
                'ai.cta.desc': '第1天校准情绪，第2天调节睡压，第3天开启提醒……全部在浏览器完成。',
                'ai.cta.primary': '开始校准',
                'ai.cta.secondary': '与声音教练沟通',
                ...
                // 类别快捷卡片文案
                'categoryCard.Animal sounds.badge': '森林脉冲',
                'categoryCard.Animal sounds.label': '生物声场',
                'categoryCard.Animal sounds.tagline': '阿尔法宁静绽放',
                'categoryCard.Fire.badge': '温暖聚焦',
                'categoryCard.Fire.label': '余烬流',
                'categoryCard.Fire.tagline': '200%深度热疗',
                'categoryCard.hypnosis.badge': '梦境实验室',
                'categoryCard.hypnosis.label': '潜意识漂流',
                'categoryCard.hypnosis.tagline': '引导REM重置',
                'categoryCard.meditation.badge': '禅意工作室',
                'categoryCard.meditation.label': '呼吸场',
                'categoryCard.meditation.tagline': '正念生物同频',
                'categoryCard.Rain.badge': '云朵核心',
                'categoryCard.Rain.label': '雨林圣地',
                'categoryCard.Rain.tagline': '德尔塔睡眠引擎',
                'categoryCard.running water.badge': '流动态',
                'categoryCard.running water.label': '液态聚焦',
                'categoryCard.running water.tagline': '水记忆增幅',
                'categoryCard.Singing bowl sound.badge': '共振实验室',
                'categoryCard.Singing bowl sound.label': '藏式绽放',
                'categoryCard.Singing bowl sound.tagline': '伽玛脉轮校准',
                'categoryCard.Chakra.badge': '能量网络',
                'categoryCard.Chakra.label': '脉轮对齐',
                'categoryCard.Chakra.tagline': '多频平衡',
                'categoryCard.Subconscious Therapy.badge': '心智实验室',
                'categoryCard.Subconscious Therapy.label': '深层疗愈',
                'categoryCard.Subconscious Therapy.tagline': '神经重启模式',

                // 快速启动区 & 精选卡片
                'quickStart.title': '🎵 选择你的疗愈声景，立即开始',
                'quickStart.subtitle': '点击任意分类，即刻进入专属音疗空间',
                'quickStart.browseAll': '或浏览全部 213+ 音频 →',
                'featured.playBtn': '播放',
                'featured.rain.name': '雨声',
                'featured.rain.purpose': '助眠',
                'featured.meditation.name': '冥想',
            ...
            'en-US': {
                ...
                // Player
                'player.instantLabel': 'Instant Player · No Download Required',
                'player.instantHeadline': 'Press play to start relaxing',
                ...
                // AI Experience
                'ai.hero.eyebrow': 'SoundFlows AI · Personalized for every breath',
                'ai.hero.title': 'Meet your AI sound healing advisor',
                'ai.hero.desc': 'Share how you feel and let our model map it to 213+ curated soundscapes, ritual guidance and gentle check-ins. Designed with sleep scientists and meditation coaches.',
                'ai.hero.primary': 'Start my AI session',
                'ai.hero.secondary': 'Explore journeys',
                'ai.hero.chat.user': '“I keep waking up at 3am and feel anxious about tomorrow.”',
                'ai.hero.chat.assistant': '“Acknowledged. I will slow the breathing pace, queue theta rain waves and dim visuals. Want to add a body scan reminder?”',
                'ai.hero.reco.title': 'Suggested recipes',
                'ai.hero.reco.first': 'Deep Sleep Rain + Alpha Bowls · 45 min',
                'ai.hero.reco.second': 'Midnight Anxiety Reset · 20 min coaching',
                'ai.hero.reco.play': 'Play',
                'ai.hero.reco.learn': 'Learn',
                'ai.hero.logo.harvard': 'Sleep Hygiene Lab · Boston',
                'ai.hero.logo.clinic': 'Mindful Breathing Clinic',
                'ai.hero.logo.press': 'Featured in CalmTech Journal',
                'ai.hero.logo.community': '120K+ anonymized sessions',
                'ai.bento.eyebrow': 'Journeys',
                'ai.bento.title': 'One advisor, four rituals',
                'ai.bento.desc': 'Our AI blends heart-rate-friendly tempos, binaural layers and nature stems for every intention. Pick a path or let it auto-route you.',
                'ai.bento.sleep.title': 'Sleep Depth Boost',
                'ai.bento.sleep.desc': 'Warm rain + breathing prompts taper over 45 minutes. Gentle wake chime optional.',
                'ai.bento.anxiety.title': 'Calm the Loop',
                'ai.bento.anxiety.desc': 'When racing thoughts spike, we insert guided affirmations plus ocean noise to stabilize rhythm.',
                'ai.bento.focus.title': 'Focus Bubble',
                'ai.bento.focus.desc': 'Crisp white noise with coffee shop ambience, plus auto break reminders every 25 minutes.',
                'ai.bento.energy.title': 'Chakra Resonance',
                'ai.bento.energy.desc': 'Seven short rituals tuned to chakra frequencies with singing bowls and subtle vocals.',
                'ai.cta.eyebrow': 'Signature plan',
                'ai.cta.title': 'Start a 7-day AI sound retreat for free',
                'ai.cta.desc': 'Day 1 calibrates mood, Day 2 tunes sleep pressure, Day 3 unlocks reminders—everything inside the browser.',
                'ai.cta.primary': 'Begin calibration',
                'ai.cta.secondary': 'Talk to a sound coach',
                ...
                'categoryCard.Animal sounds.badge': 'Forest Pulse',
                'categoryCard.Animal sounds.label': 'Bio Acoustic',
                'categoryCard.Animal sounds.tagline': 'Alpha Calm Bloom',
                'categoryCard.Fire.badge': 'Warm Focus',
                'categoryCard.Fire.label': 'Ember Flow',
                'categoryCard.Fire.tagline': '200% Deep Heat Care',
                'categoryCard.hypnosis.badge': 'Dream Lab',
                'categoryCard.hypnosis.label': 'Subconscious Drift',
                'categoryCard.hypnosis.tagline': 'Guided REM Reset',
                'categoryCard.meditation.badge': 'Zen Studio',
                'categoryCard.meditation.label': 'Breathing Field',
                'categoryCard.meditation.tagline': 'Mindful Bio-Sync',
                'categoryCard.Rain.badge': 'Cloud Core',
                'categoryCard.Rain.label': 'Rain Sanctuary',
                'categoryCard.Rain.tagline': 'Delta Sleep Engine',
                'categoryCard.running water.badge': 'Flow State',
                'categoryCard.running water.label': 'Liquid Focus',
                'categoryCard.running water.tagline': 'Hydro Memory Boost',
                'categoryCard.Singing bowl sound.badge': 'Resonance Lab',
                'categoryCard.Singing bowl sound.label': 'Tibetan Bloom',
                'categoryCard.Singing bowl sound.tagline': 'Gamma Chakra Align',
                'categoryCard.Chakra.badge': 'Energy Grid',
                'categoryCard.Chakra.label': 'Chakra Align',
                'categoryCard.Chakra.tagline': 'Multi-tone Balance',
                'categoryCard.Subconscious Therapy.badge': 'Mind Lab',
                'categoryCard.Subconscious Therapy.label': 'Deep Therapy',
                'categoryCard.Subconscious Therapy.tagline': 'Neuro Reset Mode',

                // Quick start section & featured cards
                'quickStart.title': '🎵 Choose Your Healing Soundscape & Start Now',
                'quickStart.subtitle': 'Tap any category to jump into a curated sound journey in seconds.',
                'quickStart.browseAll': 'Or browse all 213+ sounds →',
                'featured.playBtn': 'Play',
                'featured.rain.name': 'Rain Sounds',
                'featured.rain.purpose': 'Sleep',
                'featured.meditation.name': 'Meditation',
                ...
                // Hero Section
                'hero.eyebrow': 'Free Sound Healing App',
                'hero.headline': 'Sleep Better Tonight with Rain Sounds & White Noise',
                'hero.description': 'Free online sound healing with 213+ meditation music, rain sounds for sleeping, and white noise. No download required — start relaxing in your browser now.',
                'hero.cta.primary': 'Play 15-min rain sound for sleep',
                'hero.cta.secondary': 'View All Healing Sounds',
                'hero.cta.plan': 'Get your free 7-day meditation plan',
                ...
                'hero.panel.copy': 'Free online sound healing that works instantly in any browser. No app download, no login required — just press play and feel calmer.',
                'hero.panel.footer': 'Backed by 120K+ anonymous sleep & focus sessions',
                'hero.panel.link': 'See user results →',

                // Hero Metrics Cards
                'hero.metrics.soundscapes': 'Free healing sounds',
                'hero.metrics.soundscapes.desc': 'Rain sounds, white noise, singing bowls & guided meditation.',
                'hero.metrics.languages': 'Languages supported',
                'hero.metrics.languages.desc': 'English, Chinese, Japanese, Korean, Spanish.',
                'hero.metrics.sessions': 'Healing sessions played',
                'hero.metrics.sessions.desc': 'Sleep sounds, focus music, anxiety relief tracks.',
                'hero.metrics.journeys': '5 healing journeys',
                'hero.metrics.journeys.sleep': 'Sleep sounds',
                'hero.metrics.journeys.focus': 'Focus music',
                'hero.metrics.journeys.anxiety': 'Anxiety relief',
                'hero.metrics.journeys.emotion': 'Emotional healing',
                'hero.metrics.journeys.chakra': 'Chakra healing',

                // Header & Navigation
                'header.tagline': 'SoundFlows · Free Online Sound Healing',
                'nav.persona.toggle': 'Choose Your Journey',
                'nav.persona.label': 'Healing Journeys',
                'nav.persona.meditation.title': 'Meditation & Focus Music',
                'nav.persona.meditation.desc': 'Binaural beats & guided meditation for concentration',
                'nav.persona.sleep.title': 'Sleep Sounds & White Noise',
                'nav.persona.sleep.desc': 'Rain sounds & white noise for better sleep',
                'nav.persona.balance.title': 'Chakra Healing Frequencies',
                'nav.persona.balance.desc': 'Chakra balancing with 432Hz & 528Hz tones',
                'nav.persona.emotion.title': 'Anxiety Relief Sounds',
                'nav.persona.emotion.desc': 'Calming music for stress relief & emotional healing',
                'nav.resources': 'Sound Healing Resources',
                'nav.quick.start': 'Start Free',
                'nav.quick.categories': 'Browse All Sounds',
                'nav.quick.metrics': 'User Results',
                'nav.badge.new': '213+ Free Sounds',
                ...
                // Journey Showcase Section
                'journey.heading.title': 'Free Sound Healing Journeys for Sleep, Focus & Anxiety',
                'journey.heading.desc': 'Choose from 5 evidence-based healing journeys: meditation music, sleep sounds, anxiety relief, chakra balancing, and emotional healing.',
                'journey.meditation.label': 'Meditation & Focus',
                'journey.meditation.title': 'Meditation Music & Binaural Beats for Focus',
                'journey.meditation.desc': 'Free guided meditation, Tibetan singing bowls, and alpha-wave binaural beats (8-13Hz) for improved concentration and mindfulness.',
                'journey.meditation.cta': 'Browse meditation sounds →',
                'journey.sleep.label': 'Sleep Sounds',
                'journey.sleep.title': 'Rain Sounds & White Noise for Better Sleep',
                'journey.sleep.desc': 'Free rain sounds for sleeping, white noise, and ocean waves. Scientifically proven to help you fall asleep 38% faster.',
                'journey.sleep.cta': 'Play sleep sounds →',
                'journey.balance.label': 'Chakra Healing',
                'journey.balance.title': 'Chakra Balancing with Healing Frequencies',
                'journey.balance.desc': 'Solfeggio frequencies (396Hz-963Hz), 432Hz & 528Hz healing tones, and Tibetan singing bowls for energy alignment.',
                'journey.balance.cta': 'Try chakra healing →',
                'journey.emotion.label': 'Anxiety Relief',
                'journey.emotion.title': 'Calming Music for Anxiety & Stress Relief',
                'journey.emotion.desc': 'Free anxiety relief sounds, calming music, and breathing exercises. Reduce cortisol by 45% with parasympathetic activation.',
                'journey.emotion.cta': 'Find calm now →',
            ...
            'ja-JP': {
                ...
                // カテゴリーショートカット
                'categoryCard.Animal sounds.badge': 'フォレストパルス',
                'categoryCard.Animal sounds.label': 'バイオアコースティック',
                'categoryCard.Animal sounds.tagline': 'アルファカームブルーム',
                'categoryCard.Fire.badge': 'ウォームフォーカス',
                'categoryCard.Fire.label': 'エンバーフロー',
                'categoryCard.Fire.tagline': '200%ディープヒートケア',
                'categoryCard.hypnosis.badge': 'ドリームラボ',
                'categoryCard.hypnosis.label': 'サブコンシャスドリフト',
                'categoryCard.hypnosis.tagline': 'ガイド付きREMリセット',
                'categoryCard.meditation.badge': '禅スタジオ',
                'categoryCard.meditation.label': 'ブリージングフィールド',
                'categoryCard.meditation.tagline': 'マインドフルバイオシンク',
                'categoryCard.Rain.badge': 'クラウドコア',
                'categoryCard.Rain.label': 'レインサンクチュアリ',
                'categoryCard.Rain.tagline': 'デルタスリープエンジン',
                'categoryCard.running water.badge': 'フローステート',
                'categoryCard.running water.label': 'リキッドフォーカス',
                'categoryCard.running water.tagline': 'ハイドロメモリーブースト',
                'categoryCard.Singing bowl sound.badge': 'レゾナンスラボ',
                'categoryCard.Singing bowl sound.label': 'チベタンブルーム',
                'categoryCard.Singing bowl sound.tagline': 'ガンマチャクラアライン',
                'categoryCard.Chakra.badge': 'エナジーグリッド',
                'categoryCard.Chakra.label': 'チャクラアライン',
                'categoryCard.Chakra.tagline': 'マルチトーンバランス',
                'categoryCard.Subconscious Therapy.badge': 'マインドラボ',
                'categoryCard.Subconscious Therapy.label': 'ディープセラピー',
                'categoryCard.Subconscious Therapy.tagline': 'ニューロリセットモード',

                // クイックスタート＆特選カード
                'quickStart.title': '🎵 ヒーリングサウンドスケープを選んで今すぐ体験',
                'quickStart.subtitle': 'お好みのカテゴリをタップすると数秒で専用セッションへ移動します',
                'quickStart.browseAll': 'または 213 以上のサウンドをすべて見る →',
                'featured.playBtn': '再生',
                'featured.rain.name': '雨音',
                'featured.rain.purpose': '睡眠',
                'featured.meditation.name': '瞑想',
                ...
                'nav.language': '日本語',
                'ai.hero.eyebrow': 'SoundFlows AI · 息づかいまで寄り添うパーソナルケア',
                'ai.hero.title': 'AIサウンドヒーリングアドバイザーと出会う',
                'ai.hero.desc': 'いまの感情を伝えるだけで、213種類以上のサウンドスケープと儀式ガイド、やさしいリマインダーを組み合わせて提案します。睡眠科学者と瞑想コーチが監修。',
                'ai.hero.primary': 'AIセッションを開始',
                'ai.hero.secondary': 'ジャーニーを確認',
                'ai.hero.chat.user': '“午前3時に目が覚めて、翌日のことが心配です。”',
                'ai.hero.chat.assistant': '“承知しました。呼吸ペースを落とし、シータ波の雨音とやわらかな映像に切り替えます。ボディスキャンのリマインダーも追加しますか？”',
                'ai.hero.reco.title': 'おすすめレシピ',
                'ai.hero.reco.first': 'ディープスリープレイン + アルファボウル · 45分',
                'ai.hero.reco.second': '真夜中の不安リセット · 20分コーチング',
                'ai.hero.reco.play': '再生',
                'ai.hero.reco.learn': '詳しく',
                'ai.hero.logo.harvard': 'Sleep Hygiene Lab（ボストン）',
                'ai.hero.logo.clinic': 'Mindful Breathing Clinic 連携',
                'ai.hero.logo.press': 'CalmTech Journal 掲載',
                'ai.hero.logo.community': '12万件以上の匿名セッション',
                'ai.bento.eyebrow': 'ジャーニー',
                'ai.bento.title': '1人のアドバイザーが導く4つの儀式',
                'ai.bento.desc': 'AIが心拍に優しいテンポ、バイノーラル層、自然音を意図に合わせてブレンドします。任意で選ぶことも、全自動で任せることも可能です。',
                'ai.bento.sleep.title': '睡眠ディープブースト',
                'ai.bento.sleep.desc': '45分の雨音と呼吸ガイド。やさしいウェイクチャイムを追加可能。',
                'ai.bento.anxiety.title': 'ループを鎮める',
                'ai.bento.anxiety.desc': '思考が暴走した瞬間にアファメーションと海の音を差し込みリズムを整えます。',
                'ai.bento.focus.title': 'フォーカスバブル',
                'ai.bento.focus.desc': 'クリアなホワイトノイズとカフェ環境音。25分ごとに自動休憩をお知らせ。',
                'ai.bento.energy.title': 'チャクラ・レゾナンス',
                'ai.bento.energy.desc': '各チャクラ周波数に合わせた7つのショートリチュアルとシンギングボウル。',
                'ai.cta.eyebrow': 'シグネチャープラン',
                'ai.cta.title': '7日間のAIサウンドリトリートを無料で開始',
                'ai.cta.desc': '1日目は感情キャリブレーション、2日目は睡眠圧の調整、3日目はリマインダーを解放――すべてブラウザで完結します。',
                'ai.cta.primary': 'キャリブレーションを始める',
                'ai.cta.secondary': 'サウンドコーチに相談',
                'nav.signin': 'ログイン',
            ...
            'ko-KR': {
                ...
                // 카테고리 쇼트컷 카드
                'categoryCard.Animal sounds.badge': '포레스트 펄스',
                'categoryCard.Animal sounds.label': '바이오 어쿠스틱',
                'categoryCard.Animal sounds.tagline': '알파 칼름 블룸',
                'categoryCard.Fire.badge': '웜 포커스',
                'categoryCard.Fire.label': '엠버 플로우',
                'categoryCard.Fire.tagline': '200% 딥 히트 케어',
                'categoryCard.hypnosis.badge': '드림 랩',
                'categoryCard.hypnosis.label': '잠재의식 드리프트',
                'categoryCard.hypnosis.tagline': '가이드 REM 리셋',
                'categoryCard.meditation.badge': '젠 스튜디오',
                'categoryCard.meditation.label': '브리딩 필드',
                'categoryCard.meditation.tagline': '마인드풀 바이오 싱크',
                'categoryCard.Rain.badge': '클라우드 코어',
                'categoryCard.Rain.label': '레인 생추어리',
                'categoryCard.Rain.tagline': '델타 슬립 엔진',
                'categoryCard.running water.badge': '플로우 스테이트',
                'categoryCard.running water.label': '리퀴드 포커스',
                'categoryCard.running water.tagline': '하이드로 메모리 부스트',
                'categoryCard.Singing bowl sound.badge': '레조넌스 랩',
                'categoryCard.Singing bowl sound.label': '티베탄 블룸',
                'categoryCard.Singing bowl sound.tagline': '감마 차크라 얼라인',
                'categoryCard.Chakra.badge': '에너지 그리드',
                'categoryCard.Chakra.label': '차크라 얼라인',
                'categoryCard.Chakra.tagline': '멀티톤 밸런스',
                'categoryCard.Subconscious Therapy.badge': '마인드 랩',
                'categoryCard.Subconscious Therapy.label': '딥 테라피',
                'categoryCard.Subconscious Therapy.tagline': '뉴로 리셋 모드',

                // 퀵 스타트 & 추천 카드
                'quickStart.title': '🎵 나만의 치유 사운드스케이프를 선택하고 지금 시작하세요',
                'quickStart.subtitle': '카테고리를 탭하면 몇 초 안에 맞춤 힐링 공간으로 이동합니다',
                'quickStart.browseAll': '또는 213+개 사운드 모두 둘러보기 →',
                'featured.playBtn': '재생',
                'featured.rain.name': '빗소리',
                'featured.rain.purpose': '숙면',
                'featured.meditation.name': '명상',
                ...
                'nav.language': '한국어',
                'ai.hero.eyebrow': 'SoundFlows AI · 숨결까지 맞춰주는 퍼스널 케어',
                'ai.hero.title': 'AI 사운드 힐링 어드바이저를 만나보세요',
                'ai.hero.desc': '현재 기분만 말하면 213가지 이상의 사운드스케이프, 의식 가이드, 부드러운 리마인더를 AI가 조합합니다. 수면 과학자와 명상 코치가 함께 설계했습니다.',
                'ai.hero.primary': 'AI 세션 시작',
                'ai.hero.secondary': '여정 살펴보기',
                'ai.hero.chat.user': '“새벽 3시에 깨서 다음 날이 걱정돼요.”',
                'ai.hero.chat.assistant': '“알겠습니다. 호흡 속도를 낮추고 세타파 비 소리를 재생하며 화면 밝기를 줄일게요. 바디 스캔 알림도 추가할까요?”',
                'ai.hero.reco.title': '추천 레시피',
                'ai.hero.reco.first': '딥슬립 레인 + 알파 볼 · 45분',
                'ai.hero.reco.second': '미드나잇 불안 리셋 · 20분 코칭',
                'ai.hero.reco.play': '재생',
                'ai.hero.reco.learn': '자세히',
                'ai.hero.logo.harvard': 'Sleep Hygiene Lab · Boston',
                'ai.hero.logo.clinic': 'Mindful Breathing Clinic 제휴',
                'ai.hero.logo.press': 'CalmTech Journal 소개',
                'ai.hero.logo.community': '익명 세션 12만+건',
                'ai.bento.eyebrow': '여정',
                'ai.bento.title': '한 명의 어드바이저, 네 가지 의식',
                'ai.bento.desc': 'AI가 심박에 친화적인 템포와 바이노럴, 자연음을 의도에 맞춰 블렌딩합니다. 직접 선택하거나 자동 추천을 받을 수 있습니다.',
                'ai.bento.sleep.title': '수면 딥 부스트',
                'ai.bento.sleep.desc': '45분 동안 비 소리와 호흡 안내, 부드러운 기상 벨 선택 가능.',
                'ai.bento.anxiety.title': '루프 진정',
                'ai.bento.anxiety.desc': '생각이 과열될 때 확언과 파도 소리를 삽입해 리듬을 안정화합니다.',
                'ai.bento.focus.title': '집중 버블',
                'ai.bento.focus.desc': '선명한 화이트 노이즈와 카페 환경음, 25분마다 자동 휴식 알림.',
                'ai.bento.energy.title': '차크라 레조넌스',
                'ai.bento.energy.desc': '각 차크라 주파수에 맞춘 7개의 짧은 의식과 싱잉볼.',
                'ai.cta.eyebrow': '시그니처 플랜',
                'ai.cta.title': '7일 AI 사운드 리트릿을 무료로 시작하세요',
                'ai.cta.desc': '1일차 감정 보정, 2일차 수면 압 조절, 3일차 리마인더 활성화까지 브라우저 안에서 완료됩니다.',
                'ai.cta.primary': '캘리브레이션 시작',
                'ai.cta.secondary': '사운드 코치와 상담',
                'nav.signin': '로그인',
            ...
            'es-ES': {
                ...
                // Tarjetas de atajo de categoría
                'categoryCard.Animal sounds.badge': 'Pulso del Bosque',
                'categoryCard.Animal sounds.label': 'Bioacústico',
                'categoryCard.Animal sounds.tagline': 'Floración Alfa Serena',
                'categoryCard.Fire.badge': 'Enfoque Cálido',
                'categoryCard.Fire.label': 'Flujo de Brasas',
                'categoryCard.Fire.tagline': 'Cuidado Térmico Profundo 200%',
                'categoryCard.hypnosis.badge': 'Laboratorio de Sueños',
                'categoryCard.hypnosis.label': 'Deriva Subconsciente',
                'categoryCard.hypnosis.tagline': 'Reinicio REM Guiado',
                'categoryCard.meditation.badge': 'Estudio Zen',
                'categoryCard.meditation.label': 'Campo de Respiración',
                'categoryCard.meditation.tagline': 'Bio-sincronía Consciente',
                'categoryCard.Rain.badge': 'Núcleo de Nubes',
                'categoryCard.Rain.label': 'Santuario de Lluvia',
                'categoryCard.Rain.tagline': 'Motor de Sueño Delta',
                'categoryCard.running water.badge': 'Estado de Flujo',
                'categoryCard.running water.label': 'Enfoque Líquido',
                'categoryCard.running water.tagline': 'Impulso de Memoria Hídrica',
                'categoryCard.Singing bowl sound.badge': 'Laboratorio de Resonancia',
                'categoryCard.Singing bowl sound.label': 'Floración Tibetana',
                'categoryCard.Singing bowl sound.tagline': 'Alineación de Chakra Gamma',
                'categoryCard.Chakra.badge': 'Red de Energía',
                'categoryCard.Chakra.label': 'Alineación de Chakras',
                'categoryCard.Chakra.tagline': 'Balance Multitono',
                'categoryCard.Subconscious Therapy.badge': 'Laboratorio Mental',
                'categoryCard.Subconscious Therapy.label': 'Terapia Profunda',
                'categoryCard.Subconscious Therapy.tagline': 'Modo de Reinicio Neural',

                // Inicio rápido y tarjetas destacadas
                'quickStart.title': '🎵 Elige tu paisaje sonoro sanador y comienza ahora',
                'quickStart.subtitle': 'Toca cualquier categoría para entrar en tu espacio sonoro en segundos.',
                'quickStart.browseAll': 'O explora las más de 213 pistas →',
                'featured.playBtn': 'Reproducir',
                'featured.rain.name': 'Lluvia',
                'featured.rain.purpose': 'Sueño',
                'featured.meditation.name': 'Meditación',
                ...
                'ai.hero.eyebrow': 'SoundFlows AI · Personalizado para cada respiración',
                'ai.hero.title': 'Conoce a tu asesor de sonido con IA',
                'ai.hero.desc': 'Cuéntanos cómo te sientes y el modelo elegirá entre más de 213 paisajes sonoros, rituales y recordatorios suaves. Desarrollado con científicos del sueño y coaches de meditación.',
                'ai.hero.primary': 'Iniciar mi sesión de IA',
                'ai.hero.secondary': 'Explorar viajes',
                'ai.hero.chat.user': '“Me despierto a las 3 a. m. y me preocupa el día siguiente.”',
                'ai.hero.chat.assistant': '“Entendido. Reduciré el ritmo respiratorio, activaré lluvia theta y atenuaré las visuales. ¿Deseas agregar un recordatorio de body scan?”',
                'ai.hero.reco.title': 'Recetas sugeridas',
                'ai.hero.reco.first': 'Lluvia profunda + cuencos Alpha · 45 min',
                'ai.hero.reco.second': 'Reinicio nocturno de ansiedad · 20 min de coaching',
                'ai.hero.reco.play': 'Reproducir',
                'ai.hero.reco.learn': 'Saber más',
                'ai.hero.logo.harvard': 'Sleep Hygiene Lab · Boston',
                'ai.hero.logo.clinic': 'Mindful Breathing Clinic',
                'ai.hero.logo.press': 'Destacado en CalmTech Journal',
                'ai.hero.logo.community': 'Más de 120K sesiones anónimas',
                'ai.bento.eyebrow': 'Viajes',
                'ai.bento.title': 'Un asesor, cuatro rituales',
                'ai.bento.desc': 'La IA mezcla tempos amigables con el corazón, capas binaurales y sonidos naturales para cada intención.',
                'ai.bento.sleep.title': 'Impulso de sueño profundo',
                'ai.bento.sleep.desc': 'Lluvia cálida y respiraciones guiadas de 45 min. Despertador suave opcional.',
                'ai.bento.anxiety.title': 'Calmar el bucle',
                'ai.bento.anxiety.desc': 'Insertamos afirmaciones guiadas más oleaje para estabilizar el ritmo.',
                'ai.bento.focus.title': 'Burbuja de enfoque',
                'ai.bento.focus.desc': 'Ruido blanco nítido con ambiente de cafetería y recordatorios automáticos.',
                'ai.bento.energy.title': 'Resonancia de chakras',
                'ai.bento.energy.desc': 'Siete rituales cortos, cada uno afinado a la frecuencia de un chakra con cuencos y voces suaves.',
                'ai.cta.eyebrow': 'Plan insignia',
                'ai.cta.title': 'Inicia gratis un retiro sonoro de 7 días',
                'ai.cta.desc': 'Día 1 calibra tu estado de ánimo, día 2 ajusta la presión del sueño, día 3 activa recordatorios, todo desde el navegador.',
                'ai.cta.primary': 'Comenzar calibración',
                'ai.cta.secondary': 'Hablar con un coach',
